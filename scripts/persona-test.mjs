...
const SCENARIOS = [
  ...
  },
  {
    ...
    expectType: ["task_queued", "template_tasks_queued", "needs_clarification"],
    expectRole: "research",
  ...
  },
  {
    ...
    expectType: ["task_queued", "template_tasks_queued"],
    expectRole: ["engineering", "developer", "qa"],
    note: "代码 bug 请求，可直接派 engineering/developer，或进入含 QA 的实现/修复模板",
  },
  {
    id: 7,
    name: "前端登录页开发",
    ...
    expectType: ["task_queued", "template_tasks_queued", "needs_clarification"],
    expectRole: ["frontend", "qa"],
    note: "React 前端请求，可直接派给 frontend，也可进入含验证的 founder implementation 模板",
  },
  {
    id: 8,
    name: "建设产品官网",
    input: "帮我建一个产品官网",
    expectType: ["task_queued", "template_tasks_queued", "goal_run_queued", "needs_clarification"],
    expectRole: ["frontend", "product", "qa", null],
    note: "网站建设请求，可直接排任务、走模板/goal run，或在产品定位不清时先澄清",
  },
  {
    id: 9,
    name: "战略方向决策",
    input: "我们的AI产品下一步战略方向怎么定，需要考虑哪些核心要素",
    expectType: ["smalltalk_replied", "task_queued", "template_tasks_queued", "needs_clarification"],
